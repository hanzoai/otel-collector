...
const (
	metricNameSpansCount = "o11y.meter.span.count"
	metricDescSpansCount = "The number of spans observed."
	metricNameSpansSize  = "o11y.meter.span.size"
	metricDescSpansSize  = "The size of spans observed."

	metricNameMetricsDataPointsCount = "o11y.meter.metric.datapoint.count"
	metricDescMetricsDataPointsCount = "The number of data points observed."
	metricNameMetricsDataPointsSize  = "o11y.meter.metric.datapoint.size"
	metricDescMetricsDataPointsSize  = "The size of data points observed."

	metricNameLogsCount = "o11y.meter.log.count"
	metricDescLogsCount = "The number of log records observed."
	metricNameLogsSize  = "o11y.meter.log.size"
