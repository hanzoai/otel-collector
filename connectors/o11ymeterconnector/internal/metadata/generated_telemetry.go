...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/hanzoai/otel-collector/connectors/o11ymeterconnector")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/hanzoai/otel-collector/connectors/o11ymeterconnector")
}
