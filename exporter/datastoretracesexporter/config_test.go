...
func Test_loadConfig(t *testing.T) {
	...
	defaultCfg.(*Config).DSN = "tcp://127.0.0.1:9000/?database=o11y_traces&username=admin&password=password"
	...
	assert.Equal(t, &Config{
		...
		DSN: "tcp://127.0.0.1:9000/?database=o11y_traces&username=admin&password=password",
