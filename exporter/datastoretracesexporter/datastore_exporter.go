...
const (
	...
	defaultDatasource        string = "tcp://127.0.0.1:9000/?database=o11y_traces"
	defaultTraceDatabase     string = "o11y_traces"
	...
	defaultIndexTableV3      string = "distributed_o11y_index_v3"
...
type datastoreTracesExporter struct {
	id             uuid.UUID
	Writer         *SpanWriter
...
// Crete new exporter.
func newExporter(cfg *Config, settings exporter.Settings, writerOpts []WriterOption, exporterOpts []TraceExporterOption) (*datastoreTracesExporter, error) {
	...
	exporter := datastoreTracesExporter{
		Writer: writer,
		config: storageConfig{
...
func (s *datastoreTracesExporter) pushTraceData(ctx context.Context, td ptrace.Traces) error {
	return s.pushTraceDataV3(ctx, td)
}

func (s *datastoreTracesExporter) Shutdown(_ context.Context) error {
