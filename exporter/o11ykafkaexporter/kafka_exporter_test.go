...
import (
	...
	"github.com/hanzoai/otel-collector/internal/coreinternal/testdata"
	"github.com/hanzoai/otel-collector/receiver/o11ykafkareceiver"

	"github.com/hanzoai/otel-collector/exporter/o11ykafkaexporter/internal/metadata"
)
...
func TestTracesPusher(t *testing.T) {
	...
	ctx := client.NewContext(context.Background(), client.Info{Metadata: client.NewMetadata(map[string][]string{"o11y_tenant_id": {"test_tenant_id"}})})
...
func TestLogBodyBytesGetConvertedToTextString(t *testing.T) {
	...
	producer.ExpectSendMessageWithCheckerFunctionAndSucceed(func(val []byte) error {
		unmarshaler := o11ykafkareceiver.NewPdataLogsUnmarshaler(&plog.ProtoUnmarshaler{}, defaultEncoding)
