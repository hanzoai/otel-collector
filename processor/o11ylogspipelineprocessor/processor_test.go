...
func TestTraceProcessor(t *testing.T) {
  ...
  `
	...
	// See https://github.com/hanzoai/o11y/issues/3859 for an example
...
// Test that translated O11y logs pipelines work as expected
func TestO11yLogPipelineWithRouterOp(t *testing.T) {
	confYaml := `
  operators:
      - default: noop
        id: router_o11y
