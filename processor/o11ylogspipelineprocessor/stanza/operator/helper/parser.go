...
func NewParserConfig(operatorID, operatorType string) ParserConfig {
	return ParserConfig{
		...
		ParseFrom:         o11ystanzaentry.NewBodyField(),
		ParseTo:           o11ystanzaentry.RootableField{Field: o11ystanzaentry.Field{FieldInterface: entry.NewAttributeField()}},
	}
}
...
type ParserConfig struct {
	...
	ParseFrom         o11ystanzaentry.Field         `mapstructure:"parse_from"`
	ParseTo           o11ystanzaentry.RootableField `mapstructure:"parse_to"`
	BodyField         *o11ystanzaentry.Field        `mapstructure:"body"`
...
type ParserOperator struct {
	TransformerOperator
	ParseFrom       o11ystanzaentry.Field
	ParseTo         o11ystanzaentry.Field
	BodyField       *o11ystanzaentry.Field
