...
func parseSeverityTestConfig(parseFrom o11ystanzaentry.Field, preset string, mapping map[string]any) *Config {
	cfg := NewConfigWithID("test_operator_id")
	cfg.OutputIDs = []string{"output1"}
	cfg.SeverityConfig = o11ystanzahelper.SeverityConfig{
		ParseFrom: &parseFrom,
		Preset:    preset,
		Mapping:   mapping,
	}
