	...
	testCases := []struct {
		...
		},
		{
			...
			func() (*Config, error) {
				...
				parseFrom, err := o11ystanzaentry.NewField("body.app_time")
				if err != nil {
					return cfg, err
				}
...
func TestTimeParser(t *testing.T) {
	...
	rootField := o11ystanzaentry.Field{FieldInterface: o11ystanzaentry.NewBodyField()}
	someField := o11ystanzaentry.Field{FieldInterface: o11ystanzaentry.NewBodyField("some_field")}
...
func TestTimeEpochs(t *testing.T) {
	...
	rootField := o11ystanzaentry.Field{FieldInterface: entry.NewBodyField()}
	someField := o11ystanzaentry.Field{FieldInterface: entry.NewBodyField("some_field")}
...
func makeTestEntry(t *testing.T, field o11ystanzaentry.Field, value any) *entry.Entry {
	e := entry.New()
...
func parseTimeTestConfig(layoutType, layout string, parseFrom o11ystanzaentry.Field) *Config {
	cfg := NewConfigWithID("test_operator_id")
	cfg.OutputIDs = []string{"output1"}
	cfg.TimeParser = o11ystanzahelper.TimeParser{
